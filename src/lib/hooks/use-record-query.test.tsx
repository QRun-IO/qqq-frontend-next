...
function makeTableMeta(overrides: Partial<QTableMetaData> = {}): QTableMetaData {
  return {
    ...
    primaryKeyField: 'id',
    fields: {
      id: { name: 'id', label: 'ID', type: 'INTEGER', isRequired: true, isEditable: false, isHidden: false },
      firstName: { name: 'firstName', label: 'First Name', type: 'STRING', isRequired: false, isEditable: true, isHidden: false },
      lastName: { name: 'lastName', label: 'Last Name', type: 'STRING', isRequired: false, isEditable: true, isHidden: false },
      age: { name: 'age', label: 'Age', type: 'INTEGER', isRequired: false, isEditable: true, isHidden: false },
    },
    sections: [],
    capabilities: ['QUERY', 'GET', 'INSERT', 'UPDATE', 'DELETE'],
    exposedJoins: [],
    usesVariants: false,
    hasPermission: true,
    ...overrides,
