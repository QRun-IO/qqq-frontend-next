...
test.describe('Screen formats and step flows', () => {
  test('[PRC-044] scanner-format screens show only their components and submit from the input', async ({ page, backend, diagnostics }) => {
    void diagnostics
  ...
  test('[PRC-045] state-machine processes repeat screens without a linear stepper', async ({ page, diagnostics }) => {
    void diagnostics
