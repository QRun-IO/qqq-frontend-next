...
test('[QRY-022] column statistics aggregate the filtered rows, per value and overall', async ({ page, backend, diagnostics }) => {
  void diagnostics
...
test('[QRY-023] tables without the QUERY_STATS capability offer no column statistics', async ({ page, backend, diagnostics }) => {
  void diagnostics
